...
namespace Pathfinding {
    ...
    // Если гравитация используется, зависит от множества факторов.
    // Например, если используется некинематический Rigidbody, то Rigidbody сам применит гравитацию
    // Обратите внимание, что гравитация может содержать NaN, поэтому сравнение использует !(a==b) вместо a!=b.
