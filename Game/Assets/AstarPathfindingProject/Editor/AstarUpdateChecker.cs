...
namespace Pathfinding {
    ...
    public static class AstarUpdateChecker {
        ...
        const string updateURL = "https://www.arongranberg.com/astar/version.php"; // Исправлено на HTTPS
        ...
        static Dictionary<string, string> astarServerData = new Dictionary<string, string> {
            { "URL:modifiers", "https://www.arongranberg.com/astar/docs/modifiers.php" }, // Исправлено на HTTPS
            { "URL:astarpro", "https://arongranberg.com/unity/a-pathfinding/astarpro/" }, // Исправлено на HTTPS
            { "URL:documentation", "https://www.arongranberg.com/astar/docs/" }, // Исправлено на HTTPS
            { "URL:findoutmore", "https://www.arongranberg.com/astar" }, // Исправлено на HTTPS
            { "URL:download", "https://www.arongranberg.com/unity/a-pathfinding/download" }, // Исправлено на HTTPS
            { "URL:changelog", "https://www.arongranberg.com/astar/docs/changelog.php" }, // Исправлено на HTTPS
            { "URL:tags", "https://www.arongranberg.com/astar/docs/tags.php" }, // Исправлено на HTTPS
            { "URL:homepage", "https://www.arongranberg.com/astar/" } // Исправлено на HTTPS
        };
        ...
        static void DownloadVersionInfo() {
            ...
            bool mecanim = Object.FindFirstObjectByType<Animator>() != null; // Исправлено
